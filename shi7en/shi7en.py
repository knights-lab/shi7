...
def make_arg_parser():
    ...
    parser.add_argument('--flash', help='Enable (True) or Disable (False) FLASH stiching (default: True)', choices=t_f_values.keys(), default='True', type=convert_t_or_f)
    parser.add_argument('--trim', help='Enable (True) or Disable (False) the TRIMMER (default: True)', choices=t_f_values.keys(), default='True', type=convert_t_or_f)
    parser.add_argument('--allow_outies', help='Enable (True) or Disable (False) the "outie" orientation (default: True)', choices=t_f_values.keys(), default='True', type=convert_t_or_f)
    parser.add_argument('--convert_fasta', help='Enable (True) or Disable (False) the conversion of FASTQS to FASTA (default: True)', choices=t_f_values.keys(), default='True', type=convert_t_or_f)
    parser.add_argument('--combine_fasta', help='Enable (True) or Disable (False) the FASTA append mode (default: True)', choices=t_f_values.keys(), default='True', type=convert_t_or_f)
